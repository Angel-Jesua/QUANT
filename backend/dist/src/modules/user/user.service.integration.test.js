...
jest.mock('../../utils/password', () => ({
    ...
    comparePassword: jest.fn(async (pwd, hash) => hash === `hashed:${pwd}`),
...
describe('UserService - Prisma-mocked integration', () => {
    ...
    describe('createUser - uniqueness failure', () => {
        ...
        it('throws with clear error when username/email already exist', async () => {
            ...
            await expect(service.createUser(duplicateUserData)).rejects.toThrow(/Credential validation failed: Username already exists/);
