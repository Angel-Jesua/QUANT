...
class ReportController {
    ...
    async getTrialBalance(req, res) {
        try {
            ...
            (0, error_1.logErrorContext)('ReportController.getTrialBalance', error, {
                query: req.query,
            });
     ...
     */
    async getJournalDateRange(req, res) {
        try {
            ...
            (0, error_1.logErrorContext)('ReportController.getJournalDateRange', error, {});
            res.status(500).json({
                success: false,
                error: {
                    code: 'INTERNAL_ERROR',
     ...
     */
    async getAccountLevels(req, res) {
        try {
            ...
            (0, error_1.logErrorContext)('ReportController.getAccountLevels', error, {});
            res.status(500).json({
                success: false,
                error: {
                    code: 'INTERNAL_ERROR',
    ...
    async getBalanceSheet(req, res) {
        try {
            ...
            (0, error_1.logErrorContext)('ReportController.getBalanceSheet', error, {
                query: req.query,
            });
            if (error.message === 'INVALID_DATE_FORMAT') {
                res.status(400).json({
    ...
    async getAccountMovements(req, res) {
        try {
            ...
            (0, error_1.logErrorContext)('ReportController.getAccountMovements', error, {
                query: req.query,
            });
    ...
    async getIncomeStatement(req, res) {
        try {
            const { startDate, endDate, compareStartDate, compareEndDate, includeInactive, showZeroBalances, groupByCategory } = req.query;
            // Validate required parameters
            if (!startDate || typeof startDate !== 'string') {
                res.status(400).json({
                    success: false,
            ...
            (0, error_1.logErrorContext)('ReportController.getIncomeStatement', error, {
                query: req.query,
            });
            if (error.message === 'INVALID_DATE_FORMAT') {
                res.status(400).json({
