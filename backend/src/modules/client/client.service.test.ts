...
import { ICreateClient, IUpdateClient, ClientListFilters } from './client.types';
...
describe('ClientService - Prisma-mocked tests', () => {
  ...
  describe('createClient', () => {
    const baseCreate: ICreateClient = {
      clientCode: 'CLI-001' as any,
      name: 'Acme Corp',
      currencyId: 1 as any,
      creditLimit: '2500.50',
      email: 'billing@acme.com' as any,
    };
  ...
  describe('updateClient', () => {
    ...
    it('updates allowed fields, converts creditLimit, validates currency existence', async () => {
      ...
      const result = await service.updateClient(
        200,
        {
          ...
          name: 'New Name',
          contactName: 'Mario',
          email: 'mario@example.com' as any,
          phone: '+50588887777' as any,
          address: 'Addr',
          city: 'City',
          state: 'ST' as any,
          postalCode: '11001' as any,
          creditLimit: '0',
          currencyId: 2 as any,
        } as IUpdateClient,
        7
    ...
    it('throws when attempting to change clientCode', async () => {
      ...
      await expect(
        service.updateClient(201, { clientCode: 'DIFF' as any }, 9)
