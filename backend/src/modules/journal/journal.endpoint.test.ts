 ...
 */
function printTestAsCurl(name: string, scenario: any, token: string = 'YOUR_TOKEN'): void {
  console.log(`\n=== ${name} ===`);
...
export function printAllTestScenarios(token?: string): void {
  console.log('\n========================================');
...
// Export scenarios for programmatic testing
