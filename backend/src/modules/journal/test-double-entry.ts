...
import { validateDoubleEntry } from './journal.service';
...
const result1 = validateDoubleEntry(balancedLines);
...
if (result1.errorMessage) console.log(`Error: ${result1.errorMessage}`);
...
const result2 = validateDoubleEntry(unbalancedLines);
...
if (result2.errorMessage) console.log(`Error: ${result2.errorMessage}`);
...
const result3 = validateDoubleEntry(zeroLines);
...
if (result3.errorMessage) console.log(`Error: ${result3.errorMessage}`);
...
const result4 = validateDoubleEntry(multiLines);
...
if (result4.errorMessage) console.log(`Error: ${result4.errorMessage}`);
...
const result5 = validateDoubleEntry(decimalLines);
...
const result6 = validateDoubleEntry(pennyDiffLines);
...
if (result6.errorMessage) console.log(`Error: ${result6.errorMessage}`);
