...
describe('validateDoubleEntry', () => {
  describe('Balanced entries (should pass)', () => {
    ...
    it('should accept a balanced entry with Prisma.Decimal amounts', () => {
      const lines = [
        { accountId: 1, debitAmount: new Prisma.Decimal('5000.00'), creditAmount: new Prisma.Decimal(0) },
        { accountId: 2, debitAmount: new Prisma.Decimal(0), creditAmount: new Prisma.Decimal('5000.00') },
      ];
  ...
  describe('Edge cases', () => {
    ...
    it('should handle null amounts as zero', () => {
      const lines = [
        { accountId: 1, debitAmount: 750, creditAmount: null as any },
        { accountId: 2, debitAmount: null as any, creditAmount: 750 },
      ];
