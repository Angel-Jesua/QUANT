...
async function demonstrateCredentialUniqueness() {
  ...
  const uniquenessResult1 = await userService.checkCredentialUniqueness(
  ...
  const updateUniquenessResult = await userService.checkCredentialUniqueness(
  ...
  try {
    ...
    const creationUniquenessCheck = await userService.checkCredentialUniqueness(
      newUserCreationData.username,
      newUserCreationData.email
    );
...
export { demonstrateCredentialUniqueness };
